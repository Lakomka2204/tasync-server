    ...
    async getByToken(token: string): Promise<Account | null> {
        try {
            ...
            const updatedAtSeconds = Math.floor(
                account.updatedAt.getTime() / 1000,
            );
